...
skills_weird = [
    'Accounting (INT)', 'Art Criticism (INT)',
    'Ballet (DEX)', 'Being Drunk Before Noon (CON)',
    'Being Forgotten (CHA)',
    'Birdwatching (WIS)', 'Blathering (CHA)', 'Bobsledding (STR)',
    'Bonsai (DEX)', 'Bovine Husbandry (INT)',
    'Busking (CHA)',
    'Butchery (DEX)', 'Caber Tossing (STR)',
    'Chess (INT)', 'Dog Grooming (DEX)', 'Doomsaying (WIS)',
    'Equine Husbandry (INT)',
    'Feline Husbandry (INT)', 'Food Tasting (CON)',
    'Food Cart Management (INT)', 'Freestyle Beats (CHA)',
    'Funny Walks (DEX)', 'Getting Picked Last (CHA)',
    'Gourmand (INT)', 'Horsehair Braiding (DEX)',
    'Hullabaloo (CHA)', 'Juggling (DEX)',
    'Landscaping (STR)', 'Limericks (CHA)',
    'Looking Conspicuous (CHA)', 'Milk (WIS)',
    'Mime (DEX)', 'Miniature Equine Aficionado (INT)',
    'Multi-Level Marketing (INT)',
    'Painting (DEX)', 'Poison-Making (INT)',
    'Pouting (CHA)', 'Puppetry (DEX)', 'Selfies (CHA)',
    'SEO (INT)', 'Singing (CHA)',
    'Skiing (STR)', 'Spotlight Stealing (CHA)',
    'Stone-Skipping (DEX)', 'Squaredancing (DEX)', 'Surfing (DEX)',
    'Sword-Swallowing (CON)', 'Tanning (CON)',
