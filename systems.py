...
skills_dnd = [
    ...
    'First Aid (WIS)', 'Gambling (CHA)', 'Geography (INT)', 'History, Ancient (INT)',
    'History, Local (INT)', 'Intimidation (STR or CHA)', 'Jumping (STR)',
...
skills_weird = [
    ...
    'Animal Handling (INT)', 'Animal Training (INT)',
    ...
    'Doomsaying (WIS)', 'Equine Husbandry (INT)',
