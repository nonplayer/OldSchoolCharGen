...
armour = {
    'mag': [
        'ARMOUR: Studded Leather (Light, DEF+3)',
        'ARMOUR: Leather Armour (Light, DEF+2)',
        'ARMOUR: Padded Armour (Light, DEF+1)',
        '',
        '',
    ],
    'rog': [
    ...
    'war': [
        'ARMOUR: Plate Mail (Heavy, DEF+7)',
        'ARMOUR: Splint Mail (Heavy, DEF+6)',
        'ARMOUR: Chain Mail (Medium, DEF+5)',
        'ARMOUR: Scale Mail (Medium, DEF+4)',
        'ARMOUR: Studded Leather (Light, DEF+3)',
    ],
    'hlf': [
        'ARMOUR: Splint Mail (Heavy, DEF+6)',
    ...
    'fuckall': [
        ...
        'ARMOUR: a Shield made from the lid of a rubbish bin (DEF+1)',
    ],
    'holyfuckingshit': [
...
weapons = {
    'war': [
        'ARMOUR: a Shield (DEF+1)',
        'ARMOUR: a Tower Shield (DEF+2)',
...
gear = {
    'free': [
        'Satchel (S; Qualities: Bag [5], Fragile, Wearable)', 'Rations (fresh, 1d4 units, S)', 'Torch, 1 (S)',
    ...
    'basic': [
        ...
        'Rations (preserved, 2d4 units)', 'Rations (fresh, 2d4 units)', 'Rope (50 ft)', 'Sack, Small',
