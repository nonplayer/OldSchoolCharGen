...
weapons_war = [
    ...
    'WEAPON: Axe, Hand (1H, R: 10/20/30ft, 1d6)',
    ...
    'WEAPON: Bola (R: 20/40/60ft, 1d2 special)',
    ch(['WEAPON: Bow, Long w/ 20 Arrows (R: 70/140/210ft, 1d6)',
        'WEAPON: Bow, Short w/ 20 Arrows (R: 50/100/150ft, 1d6)']),
    'WEAPON: Cestus (1H, 1d3)',
    'WEAPON: Club (1H, 1d4)',
    ch(['WEAPON: Crossbow, Heavy w/ 30 Bolts (R: 80/160/240ft, 2d4)',
        'WEAPON: Crossbow, Light w/ 30 Bolts (R: 60/120/180ft, 1d6)']),
    'WEAPON: Dagger (1H, R: 10/20/30ft, 1d4)',
    'WEAPON: Halberd (2H, 1d10)',
    'WEAPON: Hammer, Throwing (R: 10/20/30ft, 1d4)',
    'WEAPON: Hammer, War (1H, 1d6)',
    'WEAPON: Javelin (1H, R: 30/60/90ft, 1d6)',
    'WEAPON: Lance (1H, 1d10)',
    'WEAPON: Mace (1H, 1d6)',
    'WEAPON: Net (1H, R: 10/20/30ft, special)',
    'WEAPON: Pike (2H, 1d10)',
    'WEAPON: Poleaxe (2H, 1d10)',
    ch(['WEAPON: Shield, Horned (1H, 1d2)',
        'WEAPON: Shield, Knife (1H, 1d4+1)',
        'WEAPON: Shield, Sword (1H, 1d4+2)',
        'WEAPON: Shield, Tusked (1H, 1d4+1)']),
    'WEAPON: Sling w/ 30 Pellets (R: 40/80/160ft, 1d4)',
    'WEAPON: Spear (1H, R: 20/40/60ft, 1d6)',
    'WEAPON: Staff (2H, 1d6)',
    'WEAPON: Sword, Bastard (1H: 1d6+1, 2H: 1d8+1)',
    'WEAPON: Sword, Normal (1H, 1d8)',
    'WEAPON: Sword, Short (1H, 1d6)',
    'WEAPON: Sword, Two-Handed (2H, 1d10)',
    'WEAPON: Trident (1H, R: 10/20/30ft, 1d6)',
