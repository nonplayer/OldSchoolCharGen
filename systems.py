...
skills_weird = [
    'Accounting (INT)', 'Agriculture (INT)',
    'Ancient History (INT)', 'Animal Handling (INT)',
    'Animal Lore (INT)', 'Animal Training (INT)',
    'Appraising (INT)', 'Armorer (STR)',
    'Art Criticism (INT)', 'Artistic Ability (CHA)',
    'Astrology (WIS)', 'Ballet (DEX)',
    'Being Drunk Before Noon (CON)', 'Being Forgotten (CHA)',
    'Birdwatching (WIS)', 'Blacksmithing (STR)',
    'Blathering (CHA)', 'Bobsledding (STR)',
    'Bonsai (DEX)', 'Bovine Husbandry (INT)',
    'Bowyer/Fletcher (DEX)', 'Brewing (INT)',
    'Busking (CHA)', 'Butchery (DEX)',
    'Caber Tossing (STR)', 'Carpentry (STR)',
    'Charioteering (DEX)', 'Chess (INT)',
    'Cobbling (DEX)', 'Cooking (INT)',
    'Dancing (DEX)', 'Direction Sense (WIS)',
    'Disguise (WIS)', 'Dog Grooming (DEX)',
    'Doomsaying (WIS)', 'Engineering (INT)',
    'Equine Husbandry (INT)', 'Etiquette (CHA)',
    'Feline Husbandry (INT)', 'Fire-building (DEX)',
    'Fishing (WIS)', 'Food Cart Management (INT)',
    'Food Tasting (CON)', 'Forgery (DEX)',
    'Freestyle Beats (CHA)', 'Funny Walks (DEX)',
    'Gaming (INT)', 'Gem-Cutting (DEX)',
    'Getting Picked Last (CHA)', 'Gourmand (INT)',
    'Healing (INT)', 'Heraldry (INT)',
    'Herbalism (INT)', 'Horsehair Braiding (DEX)',
    'Hullabaloo (CHA)', 'Hunting (WIS)',
    'Juggling (DEX)', 'Juggling (DEX)',
    'Jumping (STR)', 'Landscaping (STR)',
    'Leatherworking (DEX)', 'Limericks (CHA)',
    'Local History (INT)', 'Looking Conspicuous (CHA)',
    'Milk (WIS)', 'Mime (DEX)',
    'Miniature Equine Aficionado (INT)', 'Mining (INT)',
    'Mountaineering (WIS)', 'Multi-Level Marketing (INT)',
    'Musical Instrument (DEX)', 'Navigation (WIS)',
    'Painting (DEX)', 'Poison-Making (INT)',
    'Pottery (DEX)', 'Pouting (CHA)',
    'Puppetry (DEX)', 'Reading Lips (INT)',
    'Religion (INT)', 'Riding, Airborne (DEX)',
    'Riding, Land (DEX)', 'Rope Use (DEX)',
    'Running (CON)', 'Seamanship (WIS)',
    'Seamstress/Tailor (DEX)', 'Selfies (CHA)',
    'SEO (INT)', 'Set Snares (DEX)',
    'Singing (CHA)', 'Singing (CHA)',
    'Skiing (STR)', 'Spellcraft (INT)',
    'Spotlight Stealing (CHA)', 'Squaredancing (DEX)',
    'Stone-Skipping (DEX)', 'Stonemasonry (STR)',
    'Surfing (DEX)', 'Survival (WIS)',
    'Swimming (STR)', 'Sword-Swallowing (CON)',
    'Tanning (CON)', 'Tightrope-Walking (DEX)',
    'Tracking (WIS)', 'Tumbling (DEX)',
    'Ursine Husbandry (CON)', 'Useless Card Tricks (DEX)',
    'Ventriloquism (CHA)', 'Weaponsmithing (STR)',
    'Weather Sense (WIS)', 'Weaving (DEX)',
]
